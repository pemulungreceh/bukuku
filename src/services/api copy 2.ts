...
const USE_MOCK_API = false; // Set ke true karena backend PHP belum running
...
class ApiService {
  private async request<T>(
    ...
    if (USE_MOCK_API) {
      console.log('🔄 Backend PHP tidak tersedia - Menggunakan Mock API (simulasi database phpMyAdmin)');
      return mockApiService.request(endpoint, options) as Promise<ApiResponse<T>>;
    }

    try {
      console.log('🌐 Mencoba koneksi ke PHP Backend:', `${API_BASE_URL}${endpoint}`);
      ...
      console.error('❌ Backend PHP Error - Server tidak berjalan di http://localhost/bukuku-api');
      console.log('💡 Solusi: Jalankan server PHP (XAMPP/WAMP/MAMP) atau gunakan Mock API');
      console.log('🔄 Fallback ke Mock API untuk demo aplikasi');
  ...
  async login(email: string, password: string) {
    if (USE_MOCK_API) {
      console.log('🔐 Mock Login - Simulasi Database: bukuku_ecommerce (phpMyAdmin)');
  ...
  async register(userData: any) {
    if (USE_MOCK_API) {
      console.log('👤 Mock Register - Simulasi Database: bukuku_ecommerce (phpMyAdmin)');
  ...
  async getBooks(params?: {
    ...
    if (USE_MOCK_API) {
      console.log('📚 Mock Books API - Simulasi Database: bukuku_ecommerce.books (phpMyAdmin)');
  ...
  async createBook(bookData: FormData) {
    if (USE_MOCK_API) {
      console.log('➕ Mock Create Book - Simulasi Database: bukuku_ecommerce.books (phpMyAdmin)');
  ...
  async updateBook(id: string, bookData: FormData) {
    if (USE_MOCK_API) {
      console.log('✏️ Mock Update Book - Simulasi Database: bukuku_ecommerce.books (phpMyAdmin)');
  ...
  async deleteBook(id: string) {
    if (USE_MOCK_API) {
      console.log('🗑️ Mock Delete Book - Simulasi Database: bukuku_ecommerce.books (phpMyAdmin)');
  ...
  async getUsers(params?: {
    ...
    if (USE_MOCK_API) {
      console.log('👥 Mock Users API - Simulasi Database: bukuku_ecommerce.users (phpMyAdmin)');
  ...
  async createUser(userData: any) {
    if (USE_MOCK_API) {
      console.log('➕ Mock Create User - Simulasi Database: bukuku_ecommerce.users (phpMyAdmin)');
  ...
  async updateUser(id: string, userData: any) {
    if (USE_MOCK_API) {
      console.log('✏️ Mock Update User - Simulasi Database: bukuku_ecommerce.users (phpMyAdmin)');
  ...
  async deleteUser(id: string) {
    if (USE_MOCK_API) {
      console.log('🗑️ Mock Delete User - Simulasi Database: bukuku_ecommerce.users (phpMyAdmin)');
  ...
  async getOrders(params?: {
    ...
    if (USE_MOCK_API) {
      console.log('📦 Mock Orders API - Simulasi Database: bukuku_ecommerce.orders (phpMyAdmin)');
  ...
  async updateOrderStatus(id: string, status: string) {
    if (USE_MOCK_API) {
      console.log('📝 Mock Update Order Status - Simulasi Database: bukuku_ecommerce.orders (phpMyAdmin)');
  ...
  async updateOrderTracking(id: string, trackingData: any) {
    if (USE_MOCK_API) {
      console.log('📦 Mock Update Order Tracking - Simulasi Database: bukuku_ecommerce.orders (phpMyAdmin)');
  ...
  async getCategories() {
    if (USE_MOCK_API) {
      console.log('🏷️ Mock Categories API - Simulasi Database: bukuku_ecommerce.categories (phpMyAdmin)');
  ...
  async getSettings() {
    if (USE_MOCK_API) {
      console.log('⚙️ Mock Settings API - Simulasi Database: bukuku_ecommerce.settings (phpMyAdmin)');
  ...
  async updateSettings(settings: any) {
    if (USE_MOCK_API) {
      console.log('💾 Mock Update Settings - Simulasi Database: bukuku_ecommerce.settings (phpMyAdmin)');
  ...
  async getDashboardStats() {
    if (USE_MOCK_API) {
      console.log('📊 Mock Dashboard Stats - Simulasi Database: bukuku_ecommerce (phpMyAdmin)');
