...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-green-500 to-green-600 text-white px-4 py-2">
        <div className="container mx-auto flex items-center justify-between text-sm">
          <div className="flex items-center space-x-2">
            ...
            <span> Gratis Ongkir Setiap Pembelian diatas Rp. 200.000 </span>
          </div>
      ...
      <section className="py-2 bg-gradient-to-r from-green-700 to-lime-300 text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-xl lg:text-2xl mb-6 text-green-100">
                #BacaAjaDulu baca buku impianmu
              </p>
              ...
              <div className="relative">                
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-white bg-opacity-10 rounded-lg p-4 text-center">
                      ...
                      <p className="font-bold text-2xl">Gratis Ongkir</p>
                      <p className="text-sm">Min. pembelian 200rb</p>
                    </div>
                    <div className="bg-white bg-opacity-10 rounded-lg p-4 text-center">
                      <Shield className="h-8 w-8 mx-auto mb-2" />
                      <p className="font-bold text-2xl">Garansi</p>
                      <p className="text-sm">100% aman</p>
                    </div>
                    <div className="bg-white bg-opacity-10 rounded-lg p-4 text-center">
                      <Clock className="h-8 w-8 mx-auto mb-2" />
                      <p className="font-bold text-2xl">Pengiriman Cepat</p>
                      <p className="text-sm">1-3 hari kerja</p>
                    </div>
                    <div className="bg-white bg-opacity-10 rounded-lg p-4 text-center">
                      <Gift className="h-8 w-8 mx-auto mb-2" />
                      <p className="font-bold text-2xl">Promo Menarik</p>
